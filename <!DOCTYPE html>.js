...
<head>
    ...
    <title>BloxStudy - Ultimate Update</title>
...
<body class="bg-[#111] text-white">
    ...
    <script type="text/babel" data-type="module">
        ...
        import { BookOpen, Star, Trophy, ArrowRight, CheckCircle, XCircle, RefreshCcw, Home, Volume2, Award, Zap, Sparkles, Loader, MessageCircleQuestion, Check, X, Play, User, Crown, Medal, Search, Bell, Menu, Gamepad2, MoveRight, Sword, Shield, Skull, MessageSquare, FileText, Book, PenTool } from 'lucide-react';

        // --- CẤU HÌNH API (Đã điền key của bạn) ---
        ...
        // --- COMPONENT ROBUX ICON ---
        // Định nghĩa trước Header để tránh lỗi ReferenceError
        ...
        // --- HÀM FORMAT TEXT ĐỂ HIGHLIGHT ---
        const formatQuestionText = (text) => {
          if (!text) return null;
          const parts = text.split('*');
          return parts.map((part, index) => {
            if (index % 2 === 1) {
              return <span key={index} className="text-[#00e08e] font-extrabold mx-1 border-b-2 border-[#00e08e]">{part}</span>;
            }
            return part;
          });
        };
        ...
        const MOCK_LEADERBOARD = [
          { id: 'u1', name: 'BloxMaster_99', xp: 4500, level: 20, avatar: getAvatar('BloxMaster', 'bottts') },
          { id: 'u2', name: 'NoobSlayer', xp: 4100, level: 18, avatar: getAvatar('NoobSlayer', 'avataaars') },
          { id: 'u3', name: 'BuildermanFan', xp: 3850, level: 15, avatar: getAvatar('Builder', 'bottts') },
          { id: 'u4', name: 'ObbyQueen', xp: 3200, level: 12, avatar: getAvatar('Queen', 'avataaars') },
          { id: 'u5', name: 'RedValkyrie', xp: 2400, level: 10, avatar: getAvatar('RedVal', 'bottts') },
        ];

        const CURRICULUM_DATA = [
          {
            id: 0,
            title: "Starter Unit: Free Time",
            image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=800&auto=format&fit=crop", 
            color: "from-purple-600 to-indigo-500",
            description: "Khởi động! Sở thích, Động từ 'be' và Đại từ nhân xưng.",
            likes: "99%",
            active: "50k",
            writingPrompt: "Write a short paragraph (3-5 sentences) about your favorite hobby.",
            vocabulary: [
              { word: "Photography", meaning: "Nhiếp ảnh", type: "noun", image: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=400&q=80" },
              { word: "Chatting online", meaning: "Trò chuyện trực tuyến", type: "verb", image: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?auto=format&fit=crop&w=400&q=80" },
              { word: "Interested in", meaning: "Quan tâm đến", type: "adj", image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=400&q=80" },
              { word: "Good at", meaning: "Giỏi về", type: "adj", image: "https://images.unsplash.com/photo-1493612276216-ee3925520721?auto=format&fit=crop&w=400&q=80" },
              { word: "Into", meaning: "Thích thú", type: "prep", image: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&w=400&q=80" }
            ],
            questions: [
              {
                id: 1,
                type: "choice",
                question: "I _______ *interested in* video games.",
              ...
              },
              {
                id: 2,
                type: "choice",
                question: "This is *my brother*. _______ name is Jack.",
                options: ["He", "His", "Him", "She"],
                answer: "His",
                explanation: "Tính từ sở hữu của 'he' (anh ấy) là 'his' (của anh ấy)."
              },
              {
                id: 3,
                type: "choice",
                question: "*We* _______ from Oxford.",
                options: ["is", "am", "are", "be"],
                answer: "are",
                explanation: "Động từ to be đi với ngôi 'We' là 'are'."
              },
              {
                id: 4,
                type: "grammar_sort",
                question: "Sắp xếp câu sau:",
                words: ["good", "at", "I", "not", "am", "art."],
                answer: "I am not good at art.",
                explanation: "Cấu trúc: Subject + be + not + good at + noun."
              }
            ]
          },
          {
            id: 1,
            title: "Unit 1: Towns & Cities",
            image: "https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?q=80&w=800&auto=format&fit=crop", 
            color: "from-blue-600 to-cyan-500",
            description: "Xây dựng thành phố! Từ vựng địa điểm và Is there/Are there?",
            likes: "94%",
            active: "12.5k",
            writingPrompt: "Describe your ideal town. What places does it have?",
            vocabulary: [
              { word: "Square", meaning: "Quảng trường", type: "noun", image: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=400&q=80" },
              { word: "Museum", meaning: "Bảo tàng", type: "noun", image: "https://images.unsplash.com/photo-1566127444979-b3d2b654e3d7?auto=format&fit=crop&w=400&q=80" },
              { word: "Library", meaning: "Thư viện", type: "noun", image: "https://images.unsplash.com/photo-1521587760476-6c12a4b040da?auto=format&fit=crop&w=400&q=80" },
              { word: "Bridge", meaning: "Cây cầu", type: "noun", image: "https://images.unsplash.com/photo-1513872553313-11f32a7620db?auto=format&fit=crop&w=400&q=80" },
              { word: "Modern", meaning: "Hiện đại", type: "adj", image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=400&q=80" }
            ],
            questions: [
              {
                id: 1,
                ...
                answer: "museum",
                explanation: "Museum (bảo tàng) là nơi trưng bày các đồ vật cũ/cổ."
              },
              {
                id: 2,
                type: "grammar_sort",
                ...
                explanation: "Cấu trúc câu hỏi số nhiều: Are there + any + plural nouns?"
              },
              {
                id: 3,
                type: "choice",
                ...
                answer: "near",
                explanation: "'Near' (gần) không cần 'to'. 'Next' phải đi với 'to'. 'Between' cần 2 vật."
              },
              {
                id: 4,
                type: "choice",
                question: "Ho Chi Minh City is _______ *than* Da Nang.",
                options: ["big", "more big", "bigger", "biggest"],
                answer: "bigger",
                explanation: "So sánh hơn với tính từ ngắn (big) -> bigger."
              }
            ]
          },
          {
            ...
            description: "Quản lý thời gian! Thói quen hàng ngày và thì Hiện tại đơn.",
            likes: "91%",
            active: "8.2k",
            writingPrompt: "Write about your typical Sunday. What do you usually do?",
            vocabulary: [
              { word: "Get up", meaning: "Thức dậy", type: "verb", image: "https://images.unsplash.com/photo-1517480448885-d6086606f8c4?auto=format&fit=crop&w=400&q=80" },
              { word: "Have breakfast", meaning: "Ăn sáng", type: "verb", image: "https://images.unsplash.com/photo-1533089862017-ec916c20519c?auto=format&fit=crop&w=400&q=80" },
              { word: "Watch TV", meaning: "Xem tivi", type: "verb", image: "https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&w=400&q=80" },
              { word: "Usually", meaning: "Thường xuyên", type: "adv", image: "https://images.unsplash.com/photo-1506784983877-45594efa4cbe?auto=format&fit=crop&w=400&q=80" },
              { word: "Never", meaning: "Không bao giờ", type: "adv", image: "https://images.unsplash.com/photo-1535385793343-27dff1413c5a?auto=format&fit=crop&w=400&q=80" }
            ],
            questions: [
              {
                id: 1,
                type: "choice",
                question: "*My avatar* usually _______ up at 6.00 a.m.",
                options: ["get", "gets", "getting", "got"],
                answer: "gets",
                explanation: "Avatar (số ít, ngôi thứ 3) nên động từ phải thêm 's' (gets)."
              },
              {
                id: 2,
                type: "choice",
                question: "_______ *your friend* play Roblox in the evening?",
                options: ["Do", "Is", "Does", "Are"],
                answer: "Does",
                explanation: "Câu hỏi hiện tại đơn với chủ ngữ số ít dùng trợ động từ 'Does'."
              },
              {
                id: 3,
                type: "grammar_sort",
                ...
                explanation: "Trạng từ chỉ tần suất (never) đứng sau động từ to be (is)."
              },
              {
                id: 4,
                type: "choice",
                ...
                answer: "do",
                explanation: "Câu hỏi với 'What time' + do + you + V?"
              }
            ]
          },
          {
            id: 3,
            title: "Unit 3: Wild Life",
            image: "https://images.unsplash.com/photo-1546182990-dffeafbe841d?q=80&w=800&auto=format&fit=crop", 
            color: "from-orange-500 to-amber-600",
            description: "Thế giới động vật! So sánh nhất và động từ khuyết thiếu Can.",
            likes: "98%",
            active: "25k",
            writingPrompt: "Compare two animals that you know. Which one is faster/bigger?",
            vocabulary: [
              { word: "Ostrich", meaning: "Đà điểu", type: "noun", image: "https://images.unsplash.com/photo-1550951122-f3f2d259275b?auto=format&fit=crop&w=400&q=80" },
              { word: "Camel", meaning: "Lạc đà", type: "noun", image: "https://images.unsplash.com/photo-1557002665-c552e1832049?auto=format&fit=crop&w=400&q=80" },
              { word: "Eagle", meaning: "Đại bàng", type: "noun", image: "https://images.unsplash.com/photo-1611082260654-e0b49c470126?auto=format&fit=crop&w=400&q=80" },
              { word: "Scorpion", meaning: "Bọ cạp", type: "noun", image: "https://images.unsplash.com/photo-1579737153723-64e0d9b4b036?auto=format&fit=crop&w=400&q=80" },
              { word: "Dangerous", meaning: "Nguy hiểm", type: "adj", image: "https://images.unsplash.com/photo-1628151015968-3a4429e9ef04?auto=format&fit=crop&w=400&q=80" }
            ],
            questions: [
              {
                id: 1,
                ...
                answer: "fastest",
                explanation: "So sánh nhất với tính từ ngắn (fast) -> the fastest."
              },
              {
                id: 2,
                type: "choice",
                question: "A camel _______ *survive* six months without water.",
                options: ["can", "cant", "cans", "canned"],
                answer: "can",
                explanation: "Động từ khuyết thiếu 'can' chỉ khả năng."
              },
              {
                id: 3,
                type: "choice",
                question: "It's the _______ animal.",
                options: ["most ugly", "ugliest", "uglier", "more ugly"],
                answer: "ugliest",
                explanation: "Ugly -> Ugliest (đổi y thành i rồi thêm est)."
              },
              {
                id: 4,
                type: "choice",
                ...
                answer: "Yes, it can.",
                explanation: "Câu hỏi với 'Can' trả lời bằng 'Yes, it can'."
              }
            ]
          },
          {
            ...
            description: "Trường học Tycoon! Các môn học và thì Hiện tại tiếp diễn.",
            likes: "88%",
            active: "15k",
            writingPrompt: "What are you doing in your class right now? Describe the activities.",
            vocabulary: [
              { word: "Geography", meaning: "Địa lý", type: "noun", image: "https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=400&q=80" },
              { word: "Science", meaning: "Khoa học", type: "noun", image: "https://images.unsplash.com/photo-1564325724739-bae0bd08762c?auto=format&fit=crop&w=400&q=80" },
              { word: "Art", meaning: "Mỹ thuật", type: "noun", image: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&w=400&q=80" },
              { word: "Strict", meaning: "Nghiêm khắc", type: "adj", image: "https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=400&q=80" },
              { word: "Revise", meaning: "Ôn tập", type: "verb", image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=400&q=80" }
            ],
            questions: [
              {
                id: 1,
                type: "choice",
                question: "We _______ a geography class *right now*.",
                options: ["have", "having", "are having", "is having"],
                answer: "are having",
                explanation: "Right now -> Hiện tại tiếp diễn (be + V-ing). We -> are."
              },
              {
                id: 2,
                type: "choice",
                question: "I love *painting*. My favourite subject is _______.",
                options: ["Maths", "Art", "PE", "Science"],
                answer: "Art",
                explanation: "Painting (vẽ tranh) thuộc môn Mỹ thuật (Art)."
              },
              {
                id: 3,
                type: "grammar_sort",
                question: "Sắp xếp câu sau:",
                words: ["teacher", "writing", "The", "board.", "is", "on", "the"],
                answer: "The teacher is writing on the board.",
                explanation: "Cấu trúc HTTD: S + be + V-ing + O."
              },
              {
                id: 4,
                type: "choice",
                question: "Are they playing football? *No*, they _______.",
                options: ["aren't", "isn't", "don't", "doesn't"],
                answer: "aren't",
                explanation: "Câu hỏi Are they... -> Trả lời No, they aren't."
              }
            ]
          },
          {
            id: 5,
            title: "Unit 5: Food & Health",
            image: "https://images.unsplash.com/photo-1490818387583-1baba5e638af?q=80&w=800&auto=format&fit=crop", 
            color: "from-lime-500 to-green-700",
            description: "Nhà hàng vui vẻ! Đồ ăn và Danh từ đếm được/không đếm được.",
            likes: "92%",
            active: "20k",
            writingPrompt: "Write about your favorite meal. What ingredients do you need?",
            vocabulary: [
              { word: "Pasta", meaning: "Mỳ ống", type: "noun", image: "https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?auto=format&fit=crop&w=400&q=80" },
              { word: "Vegetables", meaning: "Rau củ", type: "noun", image: "https://images.unsplash.com/photo-1566385101042-1a0aa0c1268c?auto=format&fit=crop&w=400&q=80" },
              { word: "Fizzy drink", meaning: "Nước có ga", type: "noun", image: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?auto=format&fit=crop&w=400&q=80" },
              { word: "Healthy", meaning: "Lành mạnh", type: "adj", image: "https://images.unsplash.com/photo-1511688878353-3a2f5be94cd7?auto=format&fit=crop&w=400&q=80" },
              { word: "Unhealthy", meaning: "Không lành mạnh", type: "adj", image: "https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&w=400&q=80" }
            ],
            questions: [
              {
                id: 1,
                type: "choice",
                question: "I'd like _______ *apple*, please.",
              ...
              },
              {
                id: 2,
                type: "choice",
                question: "There *isn't* _______ juice in the fridge.",
                options: ["some", "many", "any", "a"],
                answer: "any",
                explanation: "Câu phủ định với danh từ không đếm được (juice) dùng 'any'."
              },
              {
                id: 3,
                type: "choice",
              ...
              },
              {
                id: 4,
                type: "choice",
                question: "You _______ *eat too many sweets*. It's bad for your teeth.",
                options: ["should", "shouldn't", "can", "must"],
                answer: "shouldn't",
                explanation: "Shouldn't (không nên) dùng để đưa ra lời khuyên."
              }
            ]
          },
          {
            ...
            description: "Thế vận hội! Các môn thể thao và Quá khứ đơn (was/were).",
            likes: "95%",
            active: "30k",
            writingPrompt: "Write about a sports event you watched or played in the past.",
            vocabulary: [
              { word: "Athletics", meaning: "Điền kinh", type: "noun", image: "https://images.unsplash.com/photo-1552674605-469455965637?auto=format&fit=crop&w=400&q=80" },
              { word: "Gymnastics", meaning: "Thể dục dụng cụ", type: "noun", image: "https://images.unsplash.com/photo-1577471488278-16eec37ffcc2?auto=format&fit=crop&w=400&q=80" },
              { word: "Champion", meaning: "Nhà vô địch", type: "noun", image: "https://images.unsplash.com/photo-1578269174936-2709b6aeb913?auto=format&fit=crop&w=400&q=80" },
              { word: "Compete", meaning: "Thi đấu", type: "verb", image: "https://images.unsplash.com/photo-1517649763962-0c623066013b?auto=format&fit=crop&w=400&q=80" },
              { word: "Medal", meaning: "Huy chương", type: "noun", image: "https://images.unsplash.com/photo-1565514020128-40346399c54e?auto=format&fit=crop&w=400&q=80" }
            ],
            questions: [
              {
                id: 1,
                type: "choice",
                question: "In 2016, the Olympics _______ in Rio.",
                options: ["is", "are", "was", "were"],
                answer: "were",
                explanation: "Olympics (số nhiều) + Quá khứ (2016) -> were."
              },
              {
                id: 2,
                type: "choice",
                question: "There _______ any gold medals in the first Olympics.",
                options: ["wasn't", "weren't", "isn't", "aren't"],
                answer: "weren't",
                explanation: "Gold medals (số nhiều) + Phủ định quá khứ -> weren't."
              },
              {
                id: 3,
                type: "choice",
                question: "Usain Bolt _______ three gold medals in 2012.",
                options: ["win", "winned", "won", "wins"],
                answer: "won",
                explanation: "Động từ bất quy tắc: win -> won (quá khứ)."
              },
              {
                id: 4,
                type: "grammar_sort",
                ...
                explanation: "Cấu trúc câu hỏi quá khứ với to be: Wh- + was/were + S...?"
              }
            ]
          },
          {
            ...
            description: "Mô phỏng cuộc sống! Miêu tả người và Quá khứ đơn.",
            likes: "89%",
            active: "18k",
            writingPrompt: "Describe a famous person you like. What does he/she look like?",
            vocabulary: [
              { word: "Blonde", meaning: "Vàng hoe (tóc)", type: "adj", image: "https://images.unsplash.com/photo-1582250228330-0836511b0e9f?auto=format&fit=crop&w=400&q=80" },
              { word: "Curly", meaning: "Xoăn (tóc)", type: "adj", image: "https://images.unsplash.com/photo-1595152452543-e5fc28ebc2b8?auto=format&fit=crop&w=400&q=80" },
              { word: "Moustache", meaning: "Ria mép", type: "noun", image: "https://images.unsplash.com/photo-1601344445585-6e06b3c2005a?auto=format&fit=crop&w=400&q=80" },
              { word: "Grow up", meaning: "Lớn lên", type: "verb", image: "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=400&q=80" },
              { word: "Average height", meaning: "Chiều cao trung bình", type: "noun", image: "https://images.unsplash.com/photo-1517423568366-2b8e37a5180f?auto=format&fit=crop&w=400&q=80" }
            ],
            questions: [
              {
                id: 1,
                type: "choice",
                question: "He _______ *tall* and he has got short hair.",
                options: ["is", "has", "have", "are"],
                answer: "is",
                explanation: "Miêu tả chiều cao dùng động từ to be (is tall)."
              },
              {
                id: 2,
                type: "choice",
                question: "Where _______ you *grow up*?",
                options: ["do", "does", "did", "were"],
                answer: "did",
                explanation: "Câu hỏi quá khứ đơn với động từ thường (grow) dùng trợ động từ 'did'."
              },
              {
                id: 3,
                type: "choice",
                question: "He _______ *go* to school yesterday.",
                options: ["didn't", "don't", "doesn't", "wasn't"],
                answer: "didn't",
                explanation: "Phủ định quá khứ đơn: didn't + V nguyên mẫu."
              },
              {
                id: 4,
                type: "choice",
                question: "When I was young, I _______ *blond hair*.",
          ...
          {
            id: 8,
            title: "Unit 8: Going Away",
            image: "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=800&auto=format&fit=crop", 
            color: "from-yellow-500 to-orange-500",
            description: "Du lịch phiêu lưu! Phương tiện và Tương lai gần (Be going to).",
            likes: "97%",
            active: "42k",
            writingPrompt: "Write about your plans for the next summer holiday.",
            vocabulary: [
              { word: "Ferry", meaning: "Phà", type: "noun", image: "https://images.unsplash.com/photo-1559733054-d84457e4e1a0?auto=format&fit=crop&w=400&q=80" },
              { word: "Subway", meaning: "Tàu điện ngầm", type: "noun", image: "https://images.unsplash.com/photo-1490237736630-d309062b0837?auto=format&fit=crop&w=400&q=80" },
              { word: "Ticket", meaning: "Vé", type: "noun", image: "https://images.unsplash.com/photo-1549488352-257a31bdfbd1?auto=format&fit=crop&w=400&q=80" },
              { word: "Luggage", meaning: "Hành lý", type: "noun", image: "https://images.unsplash.com/photo-1565514020176-353273e86c06?auto=format&fit=crop&w=400&q=80" },
              { word: "Guidebook", meaning: "Sách hướng dẫn", type: "noun", image: "https://images.unsplash.com/photo-1527838832700-5059252407fa?auto=format&fit=crop&w=400&q=80" }
            ],
            questions: [
              {
                id: 1,
                type: "choice",
                question: "We _______ *going to* visit Paris next week.",
                options: ["is", "am", "are", "be"],
                answer: "are",
                explanation: "Cấu trúc tương lai gần: S + be + going to + V. We -> are."
              },
              {
                id: 2,
                type: "choice",
                question: "I'm going to travel _______ *plane*.",
                options: ["on", "in", "by", "with"],
                answer: "by",
                explanation: "Phương tiện đi lại dùng giới từ 'by' (by plane, by bus)."
              },
              {
                id: 3,
                type: "choice",
                question: "What are you going to _______ this summer?",
                options: ["do", "did", "doing", "does"],
                answer: "do",
                explanation: "Sau 'going to' là động từ nguyên mẫu (do)."
              },
              {
                id: 4,
                type: "choice",
                question: "It's hot. You _______ *take some water*.",
                options: ["should", "shouldn't", "won't", "isn't"],
                answer: "should",
                explanation: "Lời khuyên: Nên mang theo nước."
              }
            ]
          }
        ];
          ...
          return (
            <div className="min-h-screen bg-[#111] flex items-center justify-center p-4 relative overflow-hidden font-sans">
              ...
              <div className="bg-[#232527]/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 w-full max-w-md text-center border border-[#393b3d] relative z-10 animate-slideUp">
                ...
                <p className="text-gray-300 mb-8 font-medium">Nhập tên nhân vật của bạn để tham gia server!</p>
        ...
        const UnitCard = ({ unit, onStart, onAIGenerate, onReviewVocab, onWritingChallenge, locked, isGenerating, progress = 0 }) => (
          <div 
            ...
            >
              ...
              <div className="absolute bottom-2 left-2 flex space-x-2 z-10">
                <span className="bg-black/60 backdrop-blur-sm text-white text-xs font-bold px-2 py-1 rounded flex items-center">
                  <span className="text-green-400 mr-1">👍</span> {unit.likes || "95%"}
                </span>
                <span className="bg-black/60 backdrop-blur-sm text-white text-xs font-bold px-2 py-1 rounded flex items-center">
                ...
                <div className="mt-auto space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button 
                      ...
                      className="flex-1 bg-[#00b06f] hover:bg-[#00e08e] text-white font-black py-3 rounded-lg shadow-[0_4px_0_#008252] active:shadow-none active:translate-y-1 transition-all flex items-center justify-center text-sm md:text-base"
                    >
                      <Play size={18} className="mr-2 fill-white" />
                      {progress > 0 ? "Tiếp tục" : "Vào học"}
                    </button>
                    
                    <button 
                      onClick={() => onAIGenerate(unit)}
                      disabled={isGenerating}
                      className="flex-1 bg-purple-600 hover:bg-purple-500 text-white font-black py-3 rounded-lg shadow-[0_4px_0_#5b21b6] active:shadow-none active:translate-y-1 transition-all disabled:opacity-50 flex items-center justify-center text-sm md:text-base"
                    >
                      {isGenerating ? <Loader size={18} className="animate-spin mr-2"/> : <Sparkles size={18} className="mr-2"/>}
                      Luyện AI
                    </button>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button 
                      onClick={() => onReviewVocab(unit)}
                      className="bg-[#393b3d] hover:bg-[#4b4d4f] text-white font-bold py-2 rounded-lg border-2 border-[#555] transition-colors flex items-center justify-center text-sm"
                    >
                      <Book size={16} className="mr-2" /> Từ vựng
                    </button>
                    <button 
                      onClick={() => onWritingChallenge(unit)}
                      className="bg-[#c2410c] hover:bg-[#ea580c] text-white font-bold py-2 rounded-lg border-2 border-[#7c2d12] transition-colors flex items-center justify-center text-sm"
                    >
                      <PenTool size={16} className="mr-2" /> Viết
                    </button>
                  </div>
                </div>
              ) : (
        ...
        const QuizScreen = ({ unit, onComplete, onBack, onAnswerSubmit, initialIndex = 0 }) => {
          ...
          const askAITeacher = async () => {
            setIsLoadingAI(true);
            const prompt = `Giải thích ngắn gọn cho game thủ Roblox lớp 6 tại sao đáp án: "${question.question}" lại là "${question.answer}". Dùng ngôn ngữ vui vẻ, game thủ.`;
              ...
              <div className="flex flex-col md:flex-row gap-6 items-stretch relative z-10">
                ...
                <div className="md:w-1/4 flex flex-col items-center justify-start space-y-4 animate-slideUp">
                  ...
                  <div className="bg-white text-black p-4 rounded-2xl rounded-tl-none border-4 border-gray-300 shadow-xl relative w-full font-medium text-sm md:text-base">
                    <p>"Hey there! Can you solve this challenge?"</p>
                ...
                <div className="flex-1 bg-[#1e1e24] p-6 md:p-10 rounded-3xl border-4 border-[#393b3d] shadow-2xl relative min-h-[400px] flex flex-col justify-center">
                  ...
                  {question.type === 'reading' && question.passage && (
                    <div className="mb-6 p-4 bg-black/30 rounded-xl border border-white/10 text-gray-300 text-sm md:text-base leading-relaxed font-serif">
                      <div className="flex items-center gap-2 mb-2 text-[#00b06f] font-bold uppercase text-xs">
        ...
        // --- WRITING ARENA SCREEN ---
        const WritingScreen = ({ unit, onBack, onCompleteWriting }) => {
          ...
          const handleSubmit = async () => {
            if (!text.trim()) return;
            setIsGrading(true);
            const prompt = `Grade this student's writing for Grade 6 English level. Topic: "${unit.writingPrompt}". Student Answer: "${text}". 
            Evaluate grammar, vocabulary usage, and relevance. 
            Return a JSON object: { "score": (0-10), "comment": "Feedback in Vietnamese like a game boss", "xp": (score * 10) }`;
            
            const result = await callGeminiAPI(prompt, true);
            setFeedback(result);
            setIsGrading(false);
            if(result && result.xp) {
                onCompleteWriting(result.xp);
            }
          };

          return (
            <div className="max-w-4xl mx-auto p-4 animate-fadeIn pb-20">
              <div className="flex items-center mb-6 text-white">
                ...
                <h2 className="text-3xl font-black uppercase tracking-widest flex items-center"><Sword className="mr-2" /> Writing Arena</h2>
              </div>

              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-[#232527] p-6 rounded-2xl border-4 border-[#393b3d]">
                  <div className="flex items-center gap-3 mb-4">
                      <div className="w-16 h-16 rounded-full bg-red-600 border-4 border-black overflow-hidden">
                        <img src={getAvatar("Boss", "bottts")} alt="Boss" className="w-full h-full object-cover" />
                      </div>
                      <div>
                        <h3 className="text-xl font-black text-white">BOSS CHALLENGE</h3>
                        <p className="text-gray-400 text-sm">Level 99 AI Teacher</p>
                      </div>
                  </div>
                  <div className="bg-white text-black p-4 rounded-xl border-l-8 border-red-500 font-bold mb-4 relative">
                      <p>"{unit.writingPrompt || "Write about the topic of this unit."}"</p>
                  </div>
                  <textarea 
                    value={text}
                    onChange={(e) => setText(e.target.value)}
                    placeholder="Type your answer here..."
                    className="w-full h-40 bg-black/30 border-2 border-gray-600 rounded-xl p-4 text-white resize-none focus:border-blue-500 focus:outline-none font-medium"
                    disabled={feedback}
                  />
                  {!feedback && (
                      <button 
                        ...
                        className="w-full mt-4 bg-gradient-to-r from-red-600 to-orange-600 text-white font-black py-3 rounded-xl shadow-lg hover:brightness-110 active:scale-95 transition-all flex items-center justify-center disabled:opacity-50"
                      >
                        {isGrading ? <Loader className="animate-spin" /> : <>ATTACK BOSS <Sword className="ml-2"/></>}
                      </button>
                  )}
                </div>
                ...
                <div className="relative">
                    {feedback ? (
                      <div className="bg-[#1e1e24] p-6 rounded-2xl border-4 border-yellow-500 h-full animate-slideUp">
                          <div className="text-center mb-6">
                            <h3 className="text-2xl font-black text-yellow-400 mb-2">BATTLE RESULT</h3>
                            <div className="text-6xl font-black text-white drop-shadow-lg">{feedback.score}<span className="text-2xl text-gray-500">/10</span></div>
                            <div className="text-green-400 font-bold mt-2">+{feedback.xp} Robux Earned!</div>
                          </div>
                          <div className="bg-black/40 p-4 rounded-xl border border-white/10">
                            <h4 className="text-gray-400 font-bold text-xs uppercase mb-2">Boss Feedback:</h4>
                            <p className="text-white">{feedback.comment}</p>
                          </div>
                          <button onClick={onBack} className="w-full mt-6 bg-[#393b3d] hover:bg-[#4b4d4f] text-white font-bold py-3 rounded-xl">Return to Lobby</button>
                      </div>
                    ) : (
                      <div className="h-full flex items-center justify-center border-4 border-dashed border-[#393b3d] rounded-2xl p-8 text-center text-gray-500 font-bold">
                          <p>Submit your writing to deal damage to the boss and earn loot!</p>
                      </div>
                    )}
                </div>
              </div>
        ...
        const VocabularyScreen = ({ unit, onBack }) => {
          ...
          return (
            <div className="max-w-4xl mx-auto p-4 animate-fadeIn pb-20">
              <div className="flex items-center mb-6 text-white">
                ...
                <div>
                    <h2 className="text-3xl font-black uppercase tracking-widest">Vocabulary</h2>
                    <p className="text-gray-400 font-bold text-sm">Unit: {unit.title}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {vocabList.map((vocab, index) => (
                  ...
                  >
                    <div className={`relative w-full h-full transition-all duration-500 transform-style-3d ${flippedIndex === index ? 'rotate-y-180' : ''}`}>
                      
                      {/* Front Side */}
                      <div className="absolute inset-0 bg-[#232527] rounded-2xl border-4 border-[#393b3d] shadow-xl flex flex-col items-center justify-center p-4 backface-hidden group-hover:border-[#00b06f] transition-colors overflow-hidden">
                        {/* Image Background */}
                        <div className="absolute inset-0 z-0">
                            <img src={vocab.image} alt={vocab.word} className="w-full h-full object-cover opacity-40" />
                            <div className="absolute inset-0 bg-gradient-to-t from-[#111] via-transparent to-[#111]"></div>
                        </div>

                        <div className="relative z-10 flex flex-col items-center">
                            <div className="text-xs font-black text-gray-300 bg-black/50 px-2 py-1 rounded mb-2 uppercase tracking-wider backdrop-blur-sm border border-white/10">{vocab.type}</div>
                            <h3 className="text-3xl font-black text-white text-center drop-shadow-lg">{vocab.word}</h3>
                            <p className="text-xs text-white/70 mt-4 font-bold bg-black/40 px-2 py-1 rounded-full flex items-center">
                                <RefreshCcw size={10} className="mr-1"/> Click to flip
                            </p>
                        </div>
                      </div>

                      {/* Back Side */}
                      <div className="absolute inset-0 bg-[#00b06f] rounded-2xl border-4 border-[#00e08e] shadow-xl flex flex-col items-center justify-center p-4 transform rotate-y-180 backface-hidden">
                        <h3 className="text-2xl font-black text-white text-center">{vocab.meaning}</h3>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              {vocabList.length === 0 && (
                  <div className="text-center text-gray-500 font-bold mt-10">No vocabulary data for this unit yet.</div>
              )}
            </div>
          );
        };
        ...
        function App() {
          ...
          const startVocabulary = (unit) => {
            setActiveUnit(unit);
            setScreen('vocabulary');
          };

          const startWritingChallenge = (unit) => {
            setActiveUnit(unit);
            setScreen('writing');
          };

          const handleWritingComplete = (xp) => {
            setTotalXP(prev => prev + xp);
            setCursorStatus('correct');
          };

          const handleAIGenerate = async (unit) => {
            setGeneratingId(unit.id);
            const prompt = `Create 5 multiple choice questions for Grade 6 English level. Topic: ${unit.title}. Context from book: ${unit.description}. IMPORTANT: Wrap keywords in question text with asterisks (*) for highlighting (e.g. "She *is going* home"). Return JSON object {questions: [{id, type:'choice', question, options:[], answer, explanation}]}`;
          ...
          return (
            <div className="min-h-screen bg-[#111] font-sans text-gray-200 pb-10 cursor-default selection:bg-green-500 selection:text-white">
              ...
              {screen !== 'quiz' && screen !== 'writing' && <Header score={totalXP} level={level} userName={userName} onLogout={handleLogout} onLeaderboardClick={() => setScreen('leaderboard')} />}
              ...
              <main className="container mx-auto px-4 pt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                      {CURRICULUM_DATA.map((unit) => (
                        <UnitCard 
                          ...
                          onReviewVocab={startVocabulary}
                          onWritingChallenge={startWritingChallenge}
                ...
                {screen === 'vocabulary' && activeUnit && (
                  <VocabularyScreen unit={activeUnit} onBack={() => setScreen('home')} />
                )}

                {screen === 'writing' && activeUnit && (
                   <WritingScreen 
                     unit={activeUnit} 
                     onBack={() => setScreen('home')} 
                     onCompleteWriting={handleWritingComplete}
                   />
                )}
